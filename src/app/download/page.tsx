...
export const metadata = {
  title: "Download Vyapar Sarthi App",
  description: "Download the Vyapar Sarthi app for Android and Windows/Mac Desktop to manage your shop offline and online.",
};
    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-[#1a2e2c] mb-4">
            Download Vyapar Sarthi
          </h1>
          <p className="text-lg text-slate-600 mb-12">
            Get the ultimate kirana management experience on your favorite device.
          </p>

          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {/* Android Card */}
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center text-center hover:shadow-2xl hover:scale-105 transition-all duration-300">
              ...
              <h2 className="text-2xl font-bold text-[#1a2e2c] mb-2">Android App</h2>
              <p className="text-sm text-slate-500 mb-8">
                Install directly on your phone for billing on the go.
              </p>
              <a
                href="/downloads/VyaparSarthi.apk"
                download
                className="mt-auto w-full px-6 py-4 rounded-xl bg-green-600 text-white font-bold text-lg shadow-lg shadow-green-600/20 hover:shadow-xl hover:shadow-green-600/30 hover:-translate-y-1 transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center text-center hover:shadow-2xl hover:scale-105 transition-all duration-300">
              ...
              <h2 className="text-2xl font-bold text-[#1a2e2c] mb-2">Windows Desktop</h2>
              <p className="text-sm text-slate-500 mb-8">
                Fast, offline-ready desktop billing software.
              </p>
              <a
                href="/downloads/VyaparSarthi-Setup.exe"
                download
                className="mt-auto w-full px-6 py-4 rounded-xl bg-blue-600 text-white font-bold text-lg shadow-lg shadow-blue-600/20 hover:shadow-xl hover:shadow-blue-600/30 hover:-translate-y-1 transition-all flex items-center justify-center gap-2"
              >
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
